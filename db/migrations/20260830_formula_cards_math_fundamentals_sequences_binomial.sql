insert into public.formula_chapters (id, subject_id, title, slug, sort_order) values
  ('jee-mathematics-fundamental-of-mathematics', 'jee-mathematics', 'Fundamental of Mathematics', 'fundamental-of-mathematics', 11),
  ('jee-mathematics-quadratic-equation', 'jee-mathematics', 'Quadratic Equation', 'quadratic-equation', 12),
  ('jee-mathematics-sequence-and-series', 'jee-mathematics', 'Sequence & Series', 'sequence-and-series', 13),
  ('jee-mathematics-binomial-theorem', 'jee-mathematics', 'Binomial Theorem', 'binomial-theorem', 14)
...
with card_seed as (
  ...
  {
    "id": "jee-mathematics-fundamental-of-mathematics-interval-types",
    "chapter_id": "jee-mathematics-fundamental-of-mathematics",
    "table_data": {
      "columns": [
        "Interval",
        "Set form",
      ...
      "rows": [
        ...
        [
          "Closed",
          "$[a,b]=\\{x:a\\le x\\le b\\}$",
          "Endpoints included; source notes this is possible only when both $a$ and $b$ are finite"
        ],
        [
          "Open-closed",
          "$(a,b]=\\{x:a<x\\le b\\}$",
          "Left endpoint open, right endpoint closed"
        ],
        [
          "Closed-open",
          "$[a,b)=\\{x:a\\le x<b\\}$",
          "Left endpoint closed, right endpoint open"
        ]
      ]
    },
    "diagram_data": null,
    ...
    "variables": [
      {
        "latex": "a",
        "symbol": "$a$",
        "meaning": "constant, endpoint, or first term"
      },
      {
        "latex": "b",
        "symbol": "$b$",
        "meaning": "constant or endpoint"
      },
      {
        "latex": "x",
        "symbol": "$x$",
    ...
    "conditions": [
      "The source assumes $a,b\\in\\mathbb{R}$ and $a<b$."
    ],
    "importance": 4,
    "source_page": 19,
    "sort_order": 1
  ...
  {
    "id": "jee-mathematics-fundamental-of-mathematics-infinite-intervals-modulus",
    "chapter_id": "jee-mathematics-fundamental-of-mathematics",
    "table_data": {
      "sections": [
        {
    ...
    "conditions": [
      "Modulus properties are stated for $a,b\\in\\mathbb{R}$."
    ],
    "importance": 4,
    "source_page": 19,
    "sort_order": 2
  ...
  {
    "id": "jee-mathematics-fundamental-of-mathematics-sum-difference-identities",
    "chapter_id": "jee-mathematics-fundamental-of-mathematics",
    "table_data": {
      "columns": [
        "Identity"
  ...
  {
    "id": "jee-mathematics-fundamental-of-mathematics-sum-product-multiple-angle",
    "chapter_id": "jee-mathematics-fundamental-of-mathematics",
    "table_data": {
      "sections": [
        {
  ...
  {
    "id": "jee-mathematics-fundamental-of-mathematics-important-trig-ratios",
    "chapter_id": "jee-mathematics-fundamental-of-mathematics",
    "table_data": {
      "columns": [
        "Ratio"
    ...
    "variables": [
      {
        "latex": "n",
        "symbol": "$n$",
        "meaning": "positive integer or index"
      }
    ],
    "conditions": [
      "The first row is stated for integer $n$."
    ],
    "importance": 4,
    "source_page": 20,
    "sort_order": 5
  ...
  {
    "id": "jee-mathematics-fundamental-of-mathematics-trig-range-series",
    "chapter_id": "jee-mathematics-fundamental-of-mathematics",
    "table_data": {
      "columns": [
        "Result",
      ...
      "rows": [
        ...
        [
          "Sine series",
          "$\\sin\\alpha+\\sin(\\alpha+\\beta)+\\cdots+\\sin(\\alpha+(n-1)\\beta)=\\frac{\\sin\\frac{n\\beta}{2}}{\\sin\\frac{\\beta}{2}}\\sin\\left(\\alpha+\\frac{n-1}{2}\\beta\\right)$"
        ],
        [
          "Cosine series",
          "$\\cos\\alpha+\\cos(\\alpha+\\beta)+\\cdots+\\cos(\\alpha+(n-1)\\beta)=\\frac{\\sin\\frac{n\\beta}{2}}{\\sin\\frac{\\beta}{2}}\\cos\\left(\\alpha+\\frac{n-1}{2}\\beta\\right)$"
        ]
      ]
    },
    "diagram_data": null,
  ...
  {
    "id": "jee-mathematics-fundamental-of-mathematics-trigonometric-equations",
    "chapter_id": "jee-mathematics-fundamental-of-mathematics",
    "table_data": {
      "columns": [
        "Equation",
      ...
      "rows": [
        [
          "$\\sin\\theta=\\sin\\alpha$",
          "$\\theta=n\\pi+(-1)^n\\alpha$, $\\alpha\\in\\left[-\\frac{\\pi}{2},\\frac{\\pi}{2}\\right]$, $n\\in\\mathbb{I}$"
        ],
        [
          "$\\cos\\theta=\\cos\\alpha$",
          "$\\theta=2n\\pi\\pm\\alpha$, $\\alpha\\in[0,\\pi]$, $n\\in\\mathbb{I}$"
        ],
        [
          "$\\tan\\theta=\\tan\\alpha$",
          "$\\theta=n\\pi+\\alpha$, $\\alpha\\in\\left(-\\frac{\\pi}{2},\\frac{\\pi}{2}\\right)$, $n\\in\\mathbb{I}$"
        ],
        [
  ...
  {
    "id": "jee-mathematics-quadratic-equation-standard-form-roots",
    "chapter_id": "jee-mathematics-quadratic-equation",
    "table_data": null,
    "diagram_data": null,
    "diagram_svg": null,
    "is_active": true,
  ...
  {
    "id": "jee-mathematics-quadratic-equation-nature-of-roots",
    "chapter_id": "jee-mathematics-quadratic-equation",
    "table_data": {
      "columns": [
        "Condition",
      ...
      "rows": [
        [
          "$D=0$",
          "Roots are equal, $\\alpha=\\beta=-\\frac{b}{2a}$"
        ],
        [
          "$a,b,c\\in\\mathbb{R}$ and $D>0$",
          "Roots are real"
        ],
        [
          "$a,b,c\\in\\mathbb{R}$ and $D<0$",
          "Roots are imaginary, $\\alpha=p+iq$, $\\beta=p-iq$"
        ],
        [
          "$a,b,c\\in\\mathbb{Q}$ and $D$ is a perfect square",
          "Roots are rational"
        ],
        [
          "$a,b,c\\in\\mathbb{Q}$ and $D$ is not a perfect square",
          "Roots are irrational, $\\alpha=p+\\sqrt q$, $\\beta=p-\\sqrt q$"
        ],
        [
          "$a=1$, $b,c\\in\\mathbb{I}$ and $D$ is a perfect square",
          "Roots are integral"
        ]
      ]
    },
  ...
  {
    "id": "jee-mathematics-quadratic-equation-common-roots",
    "chapter_id": "jee-mathematics-quadratic-equation",
    "table_data": null,
    "diagram_data": null,
    "diagram_svg": null,
    ...
    "conditions": [
      "The first formula is for both roots common.",
      "The second formula is for only one common root $\\alpha$."
    ],
    "importance": 4,
    "source_page": 23,
    "sort_order": 3
  ...
  {
    "id": "jee-mathematics-quadratic-equation-restricted-range",
    "chapter_id": "jee-mathematics-quadratic-equation",
    "table_data": {
      "columns": [
        "Condition",
      ...
      "rows": [
        [
          "$-\\frac{b}{2a}\\notin[x_1,x_2]$",
          "$f(x)\\in[\\min\\{f(x_1),f(x_2)\\},\\max\\{f(x_1),f(x_2)\\}]$"
        ],
        [
          "$-\\frac{b}{2a}\\in[x_1,x_2]$",
  ...
  {
    "id": "jee-mathematics-quadratic-equation-root-location-conditions",
    "chapter_id": "jee-mathematics-quadratic-equation",
    "table_data": {
      "columns": [
        "Root location",
      ...
      "rows": [
        [
          "Both roots greater than $x_0$",
          "$b^2-4ac\\ge0$, $f(x_0)>0$, and $-\\frac{b}{2a}>x_0$"
        ],
        [
          "Both roots smaller than $x_0$",
          "$b^2-4ac\\ge0$, $f(x_0)>0$, and $-\\frac{b}{2a}<x_0$"
        ],
        [
          "Roots on either side of $x_0$",
          "$f(x_0)<0$"
        ],
        [
          "Both roots confined between $x_1$ and $x_2$, $x_1<x_2$",
          "$b^2-4ac\\ge0$, $f(x_1)>0$, $f(x_2)>0$, and $x_1<-\\frac{b}{2a}<x_2$"
        ],
        [
          "Exactly one root in $(x_1,x_2)$",
          "$f(x_1)f(x_2)<0$"
        ]
      ]
    },
  ...
  {
    "id": "jee-mathematics-sequence-and-series-ap-terms-sum",
    "chapter_id": "jee-mathematics-sequence-and-series",
    "table_data": null,
    "diagram_data": null,
    "diagram_svg": null,
    "is_active": true,
    ...
    "conditions": [
      "$\\ell$ denotes the last term in the source sum formula."
    ],
    "importance": 5,
    "source_page": 24,
    "sort_order": 1
  ...
  {
    "id": "jee-mathematics-sequence-and-series-ap-properties-am",
    "chapter_id": "jee-mathematics-sequence-and-series",
    "table_data": {
      "columns": [
        "Topic",
      ...
      "rows": [
        ...
        [
          "Four terms in A.P.",
          "$a,b,c,d$ in A.P. $\\Rightarrow a+d=b+c$"
        ],
        [
          "Odd/even choices",
          "Three numbers: $a-d,a,a+d$; four: $a-3d,a-d,a+d,a+3d$; five: $a-2d,a-d,a,a+d,a+2d$"
        ],
        [
          "Equidistant terms",
          "Sum of terms equidistant from beginning and end equals sum of first and last term."
        ],
        [
          "Arithmetic mean",
        ...
        [
          "$n$ A.M.s",
          "$A_1=a+\\frac{b-a}{n+1}$, $A_2=a+\\frac{2(b-a)}{n+1}$, $\\ldots$, $A_n=a+\\frac{n(b-a)}{n+1}$"
        ],
        [
          "Sum of $n$ A.M.s",
          "$\\sum_{r=1}^{n}A_r=nA$, where $A$ is the single A.M. between $a$ and $b$"
        ]
      ]
    },
    "diagram_data": null,
  ...
  {
    "id": "jee-mathematics-sequence-and-series-gp-terms-sums",
    "chapter_id": "jee-mathematics-sequence-and-series",
    "table_data": null,
    "diagram_data": null,
    "diagram_svg": null,
  ...
  {
    "id": "jee-mathematics-sequence-and-series-gm-hm-relations",
    "chapter_id": "jee-mathematics-sequence-and-series",
    "table_data": {
      "columns": [
        "Topic",
      ...
      "rows": [
        [
          "G.M. of $a$ and $c$",
          "If $a,b,c>0$ are in G.P., then $b^2=ac$"
        ],
        [
          "$n$ G.M.s",
          "$G_1=a\\left(\\frac{b}{a}\\right)^{1/(n+1)}$, $G_2=a\\left(\\frac{b}{a}\\right)^{2/(n+1)}$, $\\ldots$, $G_n=a\\left(\\frac{b}{a}\\right)^{n/(n+1)}$"
        ],
        [
          "H.M. of $a$ and $c$",
          "$b=\\frac{2ac}{a+c}$"
        ...
        [
          "H.M. of $a_1,a_2,\\ldots,a_n$",
          "$\\frac{1}{H}=\\frac{1}{n}\\left[\\frac{1}{a_1}+\\frac{1}{a_2}+\\cdots+\\frac{1}{a_n}\\right]$"
        ],
        [
          "Two-number relation",
          "$G^2=AH$, $A.M.\\ge G.M.\\ge H.M.$"
        ],
        [
          "Equality",
          "$A.M.=G.M.=H.M.$ if $a_1=a_2=a_3=\\cdots=a_n$"
        ]
      ]
    },
    "diagram_data": null,
    ...
    "conditions": [
      "The G.M. rows use positive numbers as stated in the source."
    ],
    "importance": 5,
    "source_page": 25,
    "sort_order": 4
  ...
  {
    "id": "jee-mathematics-sequence-and-series-summation-properties",
    "chapter_id": "jee-mathematics-sequence-and-series",
    "table_data": {
      "columns": [
        "Property"
  ...
  {
    "id": "jee-mathematics-sequence-and-series-standard-power-sums",
    "chapter_id": "jee-mathematics-sequence-and-series",
    "table_data": {
      "columns": [
        "Sum",
  ...
  {
    "id": "jee-mathematics-binomial-theorem-statement-general-term",
    "chapter_id": "jee-mathematics-binomial-theorem",
    "table_data": null,
    "diagram_data": null,
    "diagram_svg": null,
    "is_active": true,
  ...
  {
    "id": "jee-mathematics-binomial-theorem-middle-terms",
    "chapter_id": "jee-mathematics-binomial-theorem",
    "table_data": {
      "columns": [
        "Case",
      ...
      "rows": [
        [
          "$n$ even",
          "Only one middle term: $\\left(\\frac{n+2}{2}\\right)$th term"
        ],
        [
          "$n$ odd",
          "Two middle terms: $\\left(\\frac{n+1}{2}\\right)$th and $\\left(\\frac{n+1}{2}+1\\right)$th terms"
        ]
      ]
    },
    "diagram_data": null,
  ...
  {
    "id": "jee-mathematics-binomial-theorem-multinomial-terms-application",
    "chapter_id": "jee-mathematics-binomial-theorem",
    "table_data": null,
    "diagram_data": null,
    "diagram_svg": null,
    ...
    "conditions": [
      "In the application result, $I$ and $n$ are positive integers and $n$ is odd before the first conclusion."
    ],
    "importance": 4,
    "source_page": 27,
    "sort_order": 3
  ...
  {
    "id": "jee-mathematics-binomial-theorem-coefficient-identities",
    "chapter_id": "jee-mathematics-binomial-theorem",
    "table_data": {
      "columns": [
        "Identity"
  ...
  {
    "id": "jee-mathematics-binomial-theorem-negative-fractional-index",
    "chapter_id": "jee-mathematics-binomial-theorem",
    "table_data": null,
    "diagram_data": null,
    "diagram_svg": null,
