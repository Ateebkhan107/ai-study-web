/** Publish only the final Q42 and Q61 diagram crop repairs. */
...
const repairs = [
  { questionNumber: 42, fileName: "q42.png" },
...
for (const { questionNumber, fileName } of repairs) {
  ...
  const questionImage = `${publicUrl}?v=20260829-clean3`;
...
for (const previous of before) {
  ...
  if (!current.question_image.endsWith("?v=20260829-clean3")) {
