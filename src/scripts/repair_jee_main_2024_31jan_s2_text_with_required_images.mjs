...
const PAPER_CODE = "JEE-MAIN-24-31JAN-S2";
const PDF_PATH = path.join(process.cwd(), "tmp/pdfs/source-b.pdf");
const WORK_DIR = path.join(process.cwd(), "tmp/jee-main-2024-31jan-s2-clean-repair");
...
const manualText = {
  ...
  49: {
    question: "Question 49: The output of the given circuit diagram is:",
    options: ["See figure option 1", "See figure option 2", "See figure option 3", "See figure option 4"],
  },
  68: {
...
const shiftVisualCrops = {
  33: { source: 3, page: 1, box: [170, 780, 650, 1250], note: "pulley block diagram" },
  34: { source: 4, page: 1, box: [170, 1530, 760, 1960], note: "rough inclined plane diagram" },
  49: { source: 19, page: 4, box: [170, 250, 1360, 880], note: "logic truth table options" },
  53: { source: 23, page: 4, box: [170, 1740, 760, 2080], note: "two-block pulley diagram" },
  68: { source: 38, page: 7, box: [170, 520, 1360, 1160], note: "dibromo phenylpentane structure options" },
  70: {
    source: 40,
    parts: [
      { page: 7, box: [170, 1410, 920, 1810] },
      { page: 8, box: [170, 250, 1400, 580] },
    ],
    note: "organic reaction scheme and product options",
  },
  71: { source: 41, page: 8, box: [170, 760, 1550, 1760], note: "reaction sequence and product options" },
  78: { source: 48, page: 10, box: [170, 240, 1550, 970], note: "major product structure options" },
  79: { source: 49, page: 10, box: [170, 1030, 1550, 1660], note: "azo-dye product options" },
};

const shiftManualText = {
  8: {
    question: "Question 8: Let P be a parabola with vertex $(2,3)$ and directrix $2x+y=6$. Let an ellipse $E:\\frac{x^2}{a^2}+\\frac{y^2}{b^2}=1$, $a>b$, of eccentricity $\\frac1{\\sqrt2}$ pass through the focus of the parabola P. Then the square of the length of the latus rectum of E is:",
    options: ["$\\frac{385}{8}$", "$\\frac{347}{8}$", "$\\frac{512}{25}$", "$\\frac{656}{25}$"],
  },
  9: {
    question: "Question 9: Let $f:\\mathbb R\\to(0,\\infty)$ be a strictly increasing function such that $\\lim_{x\\to\\infty}\\frac{f(7x)}{f(5x)}=1$. Then, the value of $\\lim_{x\\to\\infty}\\frac{f(x)-1}{f(x)+1}$ is:",
    options: ["4", "0", "$\\frac17$", "$\\frac15$"],
  },
  16: {
    question: "Question 16: The area of the region enclosed by the parabola $y=4x-x^2$ and $3y=x-4^2$ is equal to:",
    options: ["$\\frac{32}{4}$", "$\\frac{9}{14}$", "6", "3"],
  },
  19: {
    question: "Question 19: The shortest distance between lines $L_1$ and $L_2$ is:",
    options: ["$\\frac{121}{\\sqrt{221}}$", "$\\frac{24}{\\sqrt{117}}$", "$\\frac{141}{\\sqrt{221}}$", "$\\frac{42}{\\sqrt{117}}$"],
  },
  20: {
    question: "Question 20: A coin is biased so that a head is twice as likely to occur as a tail. If the coin is tossed 3 times, then the probability of getting two tails and one head is:",
    options: ["$\\frac29$", "$\\frac19$", "$\\frac2{27}$", "$\\frac1{27}$"],
  },
  30: {
    question: "Question 30: A line passes through $A(4,-6,-2)$ and $B(16,-2,4)$. The point $P(a,b,c)$, where a, b, c are non-negative integers, on the line AB lies at a distance of 21 units from A. The distance between $P(a,b,c)$ and $Q(4,-12,3)$ is equal to ______.",
    options: [],
  },
  33: {
    question: "Question 33: A light string passing over a smooth light fixed pulley connects two blocks of masses $m_1$ and $m_2$. If the acceleration of the system is $\\frac g8$, then the ratio of masses is:",
    options: ["$\\frac97$", "$\\frac81$", "$\\frac43$", "$\\frac53$"],
  },
  36: {
    question: "Question 36: The mass of the moon is $\\frac1{144}$ times the mass of a planet and its diameter $\\frac1{16}$ times the diameter of a planet. If the escape velocity on the planet is v, the escape velocity on the moon will be:",
    options: ["$\\frac v3$", "$\\frac v4$", "$\\frac v{12}$", "$\\frac v6$"],
  },
  37: {
    question: "Question 37: A small spherical ball of radius r, falling through a viscous medium of negligible density has terminal velocity v. Another ball of the same mass but of radius 2r, falling through the same viscous medium will have terminal velocity:",
    options: ["$\\frac v2$", "$\\frac v4$", "4v", "2v"],
  },
  40: {
    question: "Question 40: Force between two point charges $q_1$ and $q_2$ placed in vacuum at r cm apart is F. Force between them when placed in a medium having dielectric $K=5$ at $\\frac r5$ cm apart will be:",
    options: ["$\\frac F5$", "5F", "$\\frac F{25}$", "25F"],
  },
  49: {
    question: "Question 49: The output of the given circuit diagram is:",
    options: ["See figure option 1", "See figure option 2", "See figure option 3", "See figure option 4"],
  ...
  68: {
    question: "Question 68: Identify structure of 2,3-dibromo-1-phenylpentane.",
    options: ["See figure option 1", "See figure option 2", "See figure option 3", "See figure option 4"],
  },
  70: {
    question: "Question 70: Major product of the following reaction is:",
    options: ["See figure option 1", "See figure option 2", "See figure option 3", "See figure option 4"],
  },
  71: {
    question: "Question 71: Identify A and B in the following reaction sequence.",
    options: ["See figure option 1", "See figure option 2", "See figure option 3", "See figure option 4"],
  },
  78: {
    question: "Question 78: Identify major product P formed in the following reaction.",
    options: ["See figure option 1", "See figure option 2", "See figure option 3", "See figure option 4"],
  },
  79: {
    question: "Question 79: The azo-dye Y formed in the following reactions is:",
    options: ["See figure option 1", "See figure option 2", "See figure option 3", "See figure option 4"],
  },
};
...
function normalizeText(value) {
  return String(value || "")
    ...
    .replace(/J\s*EE Main 2024 \(31 Jan Shift 2\)\s*JEE Main Previous Year Paper\s*Question Paper\s*MathonGo/g, " ")
    .replace(/\u0000/g, "")
    .replace(/\s+/g, " ")
...
async function uploadImage(questionNumber) {
  ...
  const objectPath = `jee-main-2024/31jan-shift-2-required/${filename}`;
