...
ROOT = Path.cwd()
MANIFEST_PATH = ROOT / "tmp" / "jee-main-2023-april-question-image-manifest.json"
OUTPUT_ROOT = ROOT / "tmp" / "jee-main-2023-april-clean-question-images"
...
def canonical_source_url(paper_code: str, question_number: int, fallback_url: str) -> str:
    ...
    if marker in fallback_url:
        ...
        return (
            f"{base}{marker}"
            f"jee-main-2023-april-clean/{paper_code}/q{question_number:02}.png"
        )
    return fallback_url
