...
export default function ReviewQueuePage() {
  ...
  return (
    <div className="flex h-[calc(100vh-64px)] overflow-hidden bg-gray-50 dark:bg-[#0a0a0a] -m-4 md:-m-8">
      ...
      <div className="flex-1 overflow-y-auto p-6 lg:p-8">
        ...
        {/* Top Actions */}
        <div className="flex items-center justify-between mb-6 bg-white dark:bg-[#111] p-4 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm sticky top-0 z-10">
          ...
          <div className="flex items-center gap-4">
            ...
            <button onClick={handleApprove} disabled={saving} className="flex items-center gap-2 px-6 py-2 rounded-lg text-sm font-semibold bg-green-600 text-white hover:bg-green-700 shadow-md">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-[#111] p-6 rounded-2xl border border-gray-200 dark:border-gray-800">
              <h3 className="font-bold flex items-center gap-2 mb-4"><ImageIcon className="w-5 h-5" /> Question Image</h3>
              {formData.question_image ? (
                <div className="relative group">
                  <img src={formData.question_image} alt="Question" className="w-full rounded-lg border border-gray-200 dark:border-gray-700" style={{ filter: "url(#remove-orange)" }} />
                  <div className="absolute top-2 right-2 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                    <button className="p-2 bg-white rounded-lg shadow text-gray-700 hover:text-red-600" onClick={() => handleInputChange('question_image', null)}>
            ...
            <div className="bg-white dark:bg-[#111] p-6 rounded-2xl border border-gray-200 dark:border-gray-800">
              ...
              {formData.explanation_image ? (
                <div className="relative group">
                  <img src={formData.explanation_image} alt="Solution" className="w-full rounded-lg border border-gray-200 dark:border-gray-700" style={{ filter: "url(#remove-orange)" }} />
                  <div className="absolute top-2 right-2 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                    <button className="p-2 bg-white rounded-lg shadow text-gray-700 hover:text-red-600" onClick={() => handleInputChange('explanation_image', null)}>
                      <Trash2 className="w-4 h-4" />
                    </button>
                  </div>
                </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-[#111] p-6 rounded-2xl border border-gray-200 dark:border-gray-800">
              <h3 className="font-bold flex items-center gap-2 mb-4"><Type className="w-5 h-5" /> Question Text (OCR)</h3>
              <textarea 
