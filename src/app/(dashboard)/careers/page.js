    ...
    >
      <div className="max-w-4xl mx-auto space-y-12 pb-12 animate-slideUp">
        ...
        <div className="text-center space-y-4 max-w-2xl mx-auto">
          ...
          <div className="inline-block px-4 py-2 rounded-full bg-slate-100 dark:bg-[var(--surface-elevated)]/50 border border-slate-200 dark:border-[var(--border)] text-sm font-bold text-slate-700 dark:text-slate-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {DEPARTMENTS.map((dept, i) => (
              <div key={i} className="glass-card p-6 rounded-3xl group hover:border-indigo-500/30 transition-all duration-300">
                <div className="w-10 h-10 rounded-xl bg-slate-50 dark:bg-[var(--surface-elevated)]/50 flex items-center justify-center mb-4 text-slate-600 dark:text-slate-400 group-hover:text-indigo-500 group-hover:bg-indigo-50 dark:group-hover:bg-indigo-500/10 transition-colors">
        ...
        <div className="glass-card p-10 rounded-3xl border-indigo-500/20 shadow-lg shadow-indigo-500/5 text-center relative overflow-hidden">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-brand text-white dark:bg-brand dark:text-white font-bold text-sm hover:bg-brand-hover dark:hover:bg-slate-100 transition-colors shadow-lg relative z-10 group"
          >
