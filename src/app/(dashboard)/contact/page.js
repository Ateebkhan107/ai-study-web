  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto space-y-12 pb-12 animate-slideUp">
        ...
        {/* Response Time Card */}
        <div className="glass-card p-8 rounded-3xl border-slate-200/60 dark:border-[var(--border-subtle)]/50 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <a
            href="mailto:contact.prepzii@gmail.com"
            className="px-6 py-2.5 rounded-xl bg-brand text-white dark:bg-brand dark:text-white font-bold text-sm hover:bg-brand-hover dark:hover:bg-slate-100 transition-colors shadow-lg whitespace-nowrap"
          >
            Send an Email
          </a>
        </div>
