        ...
        <div className="space-y-10">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
                We offer multiple fixed-term plans (e.g., 1 Month, 6 Months, etc.). The duration of your subscription depends entirely on the plan selected at checkout. Payments are processed securely via our payment gateway, Razorpay. All features remain fully available to you continuously until the subscription expires.
              </p>
            </div>
