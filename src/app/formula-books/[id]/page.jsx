...
export default function FormulaBookPage() {
    ...
    return (
      <div className="flex h-screen items-center justify-center bg-white dark:bg-gray-950">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-sm text-gray-400 font-medium">Loading handbook...</p>
        </div>
      </div>
    );
  }
  ...
  const subjectMeta = {
    Chemistry: { color: "#10B981", bg: "rgba(16,185,129,0.08)", label: "⚗️" },
    Mathematics: { color: "#6366F1", bg: "rgba(99,102,241,0.08)", label: "📐" },
    Physics: { color: "#F59E0B", bg: "rgba(245,158,11,0.08)", label: "⚡" },
  };
  const meta = subjectMeta[book.subject] || { color: "#6366F1", bg: "rgba(99,102,241,0.08)", label: "📖" };
    ...
    <div className="h-screen w-full flex flex-col bg-gray-50 dark:bg-gray-950">
      ...
      <div className="flex items-center gap-4 bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 px-5 py-3 flex-shrink-0 shadow-sm">
        ...
        <div className="flex-1 min-w-0">
          ...
          {book.tag && (
            <p className="text-[11px] text-gray-400 mt-0.5">{book.tag}</p>
          )}
        </div>
      </div>
