export const CHEMISTRY_INORGANIC_BATCH_3_CHAPTER_DEFINITIONS = [
  { title: "s-Block Elements & their compounds", slug: "s-block-elements-compounds", sort_order: 15 },
  { title: "p-Block Elements & their compounds", slug: "p-block-elements-compounds", sort_order: 16 },
];
...
function sBlockCards(chapterId) {
  return [
    card(chapterId, "group-members-hydration", {
      title: "Group 1, Group 2 and Hydration",
      card_type: "table",
      body: "The s-block section opens with group membership and hydration trends.",
      formulas: [],
      variables: [],
      conditions: ["Lithium salts are mostly hydrated; the source example is $LiCl\\cdot 2H_2O$."],
      table_data: {
        sections: [
          {
            title: "Members",
            columns: ["Group", "Elements listed"],
            rows: [
              ["Group 1", "Li, Na, K, Rb, Cs and Fr"],
              ["Group 2", "Be, Mg, Ca, Sr, Ba and Ra"],
            ],
          },
          {
            title: "Hydration",
            columns: ["Ions", "Source-backed trend"],
            rows: [
              ["Alkali metal ions", "Hydration enthalpies decrease with increase in ionic size; $Li^+$ has maximum hydration."],
              ["Alkaline earth metal ions", "$Be^{2+}>Mg^{2+}>Ca^{2+}>Sr^{2+}>Ba^{2+}$."],
              ["Group comparison", "Alkaline earth metal ion hydration enthalpies are larger than alkali metal ion hydration enthalpies."],
            ],
          },
        ],
      },
    ...
    card(chapterId, "alkali-physical-flame", {
      ...
      formulas: [],
      variables: [],
      conditions: ["Alkali metals and their salts impart characteristic colour to an oxidizing flame."],
      table_data: {
        columns: ["Metal", "Flame colour"],
        rows: [
          ["Li", "Crimson red"],
          ["Na", "Yellow"],
          ["K", "Violet/Lilac"],
    ...
    card(chapterId, "alkali-chemical-properties", {
    ...
    card(chapterId, "lithium-anomaly-diagonal", {
      ...
      formulas: [],
      variables: [],
      conditions: ["The source says Li-Mg similarity arises because of similar size."],
      table_data: {
        columns: ["Comparison", "Source-backed values"],
        rows: [
          ["Atomic radii", "Li = 152 pm; Mg = 160 pm"],
          ["Ionic radii", "$Li^+ = 76$ pm; $Mg^{2+} = 72$ pm"],
          ["Lithium reasons", "Exceptionally small atom and ion; high charge/radius ratio."],
        ],
      },
      importance: 5,
      source_page: 75,
    ...
    card(chapterId, "alkaline-earth-properties", {
      ...
      formulas: [{ latex: "M+(x+y)NH_3\\rightarrow [M(NH_3)_x]^{2+}+2[e(NH_3)_y]^-" }],
      variables: [],
      conditions: ["From liquid ammonia solutions, ammoniates $[M(NH_3)_6]^{2+}$ can be recovered."],
      table_data: {
        sections: [
          {
            title: "Flame colours",
            columns: ["Be", "Mg", "Ca", "Sr", "Ba"],
            rows: [["No colour", "No colour", "Brick red", "Crimson", "Apple green"]],
          },
          {
            title: "Chemical behavior",
            columns: ["Property", "Source-backed point"],
            rows: [
              ["Air and water", "Be and Mg are inert to oxygen and water; Mg burns in air to give $MgO$ and $Mg_3N_2$."],
              ["Ca, Sr, Ba", "Readily attacked by air to form oxide and nitride."],
              ["Reducing nature", "Strong reducing agents, indicated by large negative reduction potentials."],
            ],
          },
        ],
      },
    ...
    card(chapterId, "beryllium-anomaly-diagonal", {
    ...
    card(chapterId, "sodium-oxide-peroxide", {
      ...
      formulas: [],
      variables: [],
      conditions: ["The full radial reaction maps remain available through the PDF fallback."],
      table_data: {
        columns: ["Compound", "Clear source-backed relationships"],
        rows: [
          ["$Na_2O$", "From Na with limited $O_2$; reacts with $H_2O$ to form $NaOH$; with $NH_3$ gives $NaNH_2+NaOH$; with $Al_2O_3$ gives $NaAlO_2$."],
          ["$Na_2O_2$", "From Na with excess $O_2$/combustion; with $H_2O$ gives $NaOH+H_2O_2$; with $CO_2$ gives $Na_2CO_3+O_2$; with Al gives $Al_2O_3+Na_2O$."],
        ],
      },
      importance: 4,
      source_page: 76,
    ...
    card(chapterId, "sodium-carbonate-lime-bleaching-powder", {
      ...
      variables: [],
      conditions: ["Clear solution of $Ca(OH)_2$ is identified as lime water."],
      importance: 4,
      source_page: 78,
      sort_order: 8,
    }),
...
function pBlockCards(chapterId) {
  return [
    card(chapterId, "p-block-overall-trends", {
      ...
      diagram_data: { type: "chem-pblock-trends" },
      importance: 5,
      source_page: 78,
      sort_order: 1,
    }),
    card(chapterId, "group-13-trends-reactions", {
      ...
      variables: [],
      conditions: ["General oxidation state of Group 13 is +3."],
      importance: 5,
      source_page: 78,
      sort_order: 2,
    }),
    card(chapterId, "boron-compounds", {
      ...
      variables: [],
      conditions: ["The full boron and borax radial maps are intentionally left to the PDF fallback."],
      table_data: {
        columns: ["Species", "Source-backed relationship"],
        rows: [
          ["Boron", "With limited air/oxygen forms $B_2O_3$; with $N_2$ gives BN."],
          ["$H_3BO_3$", "Forms $B_2O_3$ through $HBO_2$ on heating."],
          ["$Na_2B_4O_7$", "Linked to $H_3BO_3$, $NaBO_2$, $BF_3$, $B_2H_6$ and boron nitride in the source map."],
        ],
      },
      importance: 4,
      source_page: 79,
    ...
    card(chapterId, "diborane-cleavage", {
    ...
    card(chapterId, "group-14-basics", {
      ...
      formulas: [{ latex: "\\text{Electronic configuration}=ns^2np^2" }],
      variables: [],
      conditions: ["Members listed: C, Si, Ge, Sn and Pb."],
      table_data: {
        columns: ["Topic", "Source-backed item"],
        rows: [
          ["Oxidation states", "Common oxidation states are +4 and +2; carbon also exhibits negative oxidation states."],
          ["Heavier members", "Tendency to show +2 oxidation state increases: Ge < Sn < Pb."],
          ["Oxygen", "On heating in oxygen, members form monoxides MO and dioxides $MO_2$."],
          ["Water", "Tin decomposes steam to form dioxide and dihydrogen gas."],
          ["Halogens", "Halides of formula $MX_2$ and $MX_4$; stability of dihalides increases down the group."],
        ],
      },
      importance: 5,
      source_page: 80,
    ...
    card(chapterId, "group-14-catenation", {
      title: "Group 14 Catenation",
      card_type: "table",
      body: "The source connects carbon allotropy to catenation and p-p pi bond formation.",
      formulas: [{ latex: "C\\gg Si>Ge\\approx Sn" }],
      variables: [],
      conditions: ["Lead does not show catenation."],
      table_data: {
        columns: ["Bond", "Bond enthalpy / kJ mol$^{-1}$"],
        rows: [
          ["C-C", "348"],
          ["Si-Si", "297"],
          ["Ge-Ge", "260"],
    ...
    card(chapterId, "carbon-allotropes", {
      ...
      conditions: [],
      table_data: {
        columns: ["Allotrope", "Source-backed structure/property"],
        rows: [
          ["Diamond", "$sp^3$ hybridisation; each carbon linked tetrahedrally to four others; C-C length 154 pm; rigid 3D network."],
          ["Graphite", "Layered structure; layers held by van der Waals forces; layer distance 340 pm; in-layer C-C length 141.5 pm; $sp^2$ carbon."],
          ["$C_{60}$ fullerene", "Soccer-ball shape; 60 vertices; twenty six-membered rings and twelve five-membered rings; C-C distances 143.5 pm and 138.3 pm."],
        ],
      },
      importance: 4,
      source_page: 81,
    ...
    card(chapterId, "silicate-classification", {
      ...
      table_data: {
        columns: ["Class shown", "Source-backed label"],
        rows: [
          ["A", "Orthosilicates"],
          ["B", "Pyrosilicate"],
          ["C", "Cyclic silicates"],
      ...
      diagram_data: { type: "chem-silicate-tetrahedra" },
      importance: 4,
      source_page: 83,
      sort_order: 8,
    }),
    card(chapterId, "silicones", {
      title: "Silicones",
      card_type: "formula",
    ...
    card(chapterId, "group-15-basics", {
      ...
      formulas: [{ latex: "\\text{Electronic configuration}=ns^2np^3" }],
      variables: [],
      conditions: ["Except nitrogen, all elements show allotropy."],
      table_data: {
        columns: ["Topic", "Source-backed item"],
        rows: [
          ["Radii", "Covalent and ionic radii in a particular state increase down the group."],
          ["Metallic character", "Increases down the group."],
          ["Oxidation states", "Common oxidation states are -3, +3 and +5."],
          ["Inert pair trend", "+5 stability decreases and +3 stability increases down the group."],
          ["Nitrogen with oxygen", "Nitrogen also exhibits +1, +2 and +4 oxidation states."],
        ],
      },
      importance: 5,
      source_page: 84,
    ...
    card(chapterId, "group-15-hydrides", {
      title: "Group 15 Hydrides",
      card_type: "table",
      body: "The source gives hydride trends and a property table for $NH_3$ through $BiH_3$.",
      formulas: [{ latex: "NH_3>PH_3>AsH_3>SbH_3\\ge BiH_3" }],
      variables: [],
      conditions: ["Basicity decreases in the displayed order; reducing character of hydrides increases as stability decreases."],
      table_data: {
        columns: ["Property", "$NH_3$", "$PH_3$", "$AsH_3$", "$SbH_3$", "$BiH_3$"],
        rows: [
          ["m.p. / K", "195.2", "139.5", "156.7", "185", "-"],
          ["b.p. / K", "238.5", "185.5", "210.6", "254.6", "290"],
          ["E-H distance / pm", "101.7", "141.9", "151.9", "170.7", "-"],
          ["HEH angle / degree", "107.8", "93.6", "91.8", "91.3", "-"],
          ["$\\Delta_fH^\\circ$ / kJ mol$^{-1}$", "-46.1", "13.4", "66.4", "145.1", "278"],
          ["$\\Delta_{diss}H(E-H)$ / kJ mol$^{-1}$", "389", "322", "297", "255", "-"],
        ],
      },
      importance: 5,
      source_page: 85,
    ...
    card(chapterId, "group-15-oxides-halides-binary", {
    ...
    card(chapterId, "nitrogen-oxides", {
      ...
      conditions: [],
      table_data: {
        columns: ["Name", "Formula", "N oxidation state", "Preparation / appearance"],
        rows: [
          ["Dinitrogen oxide", "$N_2O$", "+1", "$NH_4NO_3\\xrightarrow{Heat}N_2O+2H_2O$; colourless neutral gas"],
          ["Nitrogen monoxide", "$NO$", "+2", "$2NaNO_2+2FeSO_4+3H_2SO_4\\rightarrow Fe_2(SO_4)_3+2NaHSO_4+2H_2O+2NO$; colourless neutral gas"],
          ["Dinitrogen trioxide", "$N_2O_3$", "+3", "$2NO+N_2O_4\\xrightarrow{250K}2N_2O_3$; blue acidic solid"],
          ["Nitrogen dioxide", "$NO_2$", "+4", "$2Pb(NO_3)_2\\xrightarrow{673K}4NO_2+2PbO+O_2$; brown acidic gas"],
          ["Dinitrogen tetroxide", "$N_2O_4$", "+4", "$2NO_2\\rightleftharpoons N_2O_4$; colourless acidic solid/liquid"],
          ["Dinitrogen pentoxide", "$N_2O_5$", "+5", "$4HNO_3+P_4O_{10}\\rightarrow 4HPO_3+2N_2O_5$; colourless acidic solid"],
        ],
      },
      importance: 5,
      source_page: 86,
    ...
    card(chapterId, "phosphorus-allotropes", {
      ...
      formulas: [{ latex: "\\text{black}>\\text{red}>\\text{white}" }],
      variables: [],
      conditions: [
    ...
    card(chapterId, "oxoacids-phosphorus", {
      ...
      conditions: [],
      table_data: {
        columns: ["Acid", "Formula", "P oxidation state", "Characteristic bonds / preparation"],
        rows: [
          ["Hypophosphorous", "$H_3PO_2$", "+1", "One P-OH, two P-H, one P=O; white $P_4$ + alkali"],
          ["Orthophosphorous", "$H_3PO_3$", "+3", "Two P-OH, one P-H, one P=O; $P_2O_3+H_2O$"],
          ["Pyrophosphorous", "$H_4P_2O_5$", "+3", "Two P-OH, two P-H, two P=O; $PCl_3+H_3PO_3$"],
          ["Hypophosphoric", "$H_4P_2O_6$", "+4", "Four P-OH, two P=O, one P-P; red $P_4$ + alkali"],
          ...
          ["Metaphosphoric", "$(HPO_3)_3$", "+5", "Three P-OH, three P=O, three P-O-P; phosphorus acid + $Br_2$, heat in sealed tube"],
        ],
      },
      importance: 5,
      source_page: 87,
    ...
    card(chapterId, "group-16-basics", {
      ...
      formulas: [{ latex: "\\text{Electronic configuration}=ns^2np^4" }],
      variables: [],
      conditions: ["Oxygen is anomalous due to small size and high electronegativity; absence of d-orbitals limits its covalency to four."],
      table_data: {
        columns: ["Topic", "Source-backed item"],
        rows: [
          ["Radii", "Atomic and ionic radii increase from top to bottom; oxygen atom is exceptionally small."],
          ["Nature", "O and S are non-metals; Se and Te metalloids; Po is a short-lived radioactive metal."],
          ["Melting/boiling points", "Increase with atomic number down the group."],
          ["Catenation", "Decreases down the group; prominently displayed by sulphur $S_8$."],
          ["Oxidation states", "+2, +4 and +6; +4 and +6 are more common."],
        ],
      },
      importance: 5,
      source_page: 88,
    ...
    card(chapterId, "group-16-hydrides", {
      ...
      table_data: {
        columns: ["Property", "$H_2O$", "$H_2S$", "$H_2Se$", "$H_2Te$"],
        rows: [
          ["m.p. / K", "273", "188", "208", "222"],
          ["b.p. / K", "373", "213", "232", "269"],
          ["H-E distance / pm", "96", "134", "146", "169"],
          ["HEH angle / degree", "104", "92", "91", "90"],
          ["$\\Delta_fH$ / kJ mol$^{-1}$", "-286", "-20", "73", "100"],
          ["$\\Delta_{diss}H(H-E)$ / kJ mol$^{-1}$", "463", "347", "276", "238"],
          ["Dissociation constant", "$1.8\\times 10^{-16}$", "$1.3\\times 10^{-7}$", "$1.3\\times 10^{-4}$", "$2.3\\times 10^{-3}$"],
        ],
      },
      importance: 5,
      source_page: 89,
    ...
    card(chapterId, "group-16-oxides-halides", {
      ...
      formulas: [{ latex: "2Se_2Cl_2\\rightarrow SeCl_4+3Se" }],
      variables: [],
      conditions: [
    ...
    card(chapterId, "sulphur-oxoacids-contact-process", {
      ...
      variables: [],
      conditions: ["The full $H_2SO_4$ reaction map remains in the PDF fallback."],
      table_data: {
        columns: ["Series", "Formula", "Oxidation state", "Name"],
        rows: [
          ["Sulphurous acid series", "$H_2SO_3$", "S(IV)", "sulphurous acid"],
          ["Sulphuric acid series", "$H_2SO_4$", "S(VI)", "sulphuric acid"],
          ["Peroxo acid series", "$H_2SO_5$", "S(VI)", "peroxomonosulphuric acid / Caro acid"],
        ],
      },
      importance: 4,
      source_page: 91,
    ...
    card(chapterId, "group-17-basics", {
      ...
      formulas: [{ latex: "\\text{Electronic configuration}=ns^2np^5" }],
      variables: [],
      conditions: [
    ...
    card(chapterId, "halogen-water-reactions", {
      ...
      variables: [],
      conditions: ["All halogens exhibit -1 oxidation state; Cl, Br and I also exhibit +1, +3, +5 and +7."],
      importance: 5,
      source_page: 92,
      sort_order: 21,
    }),
    card(chapterId, "chlorine-hx-bleaching-powder", {
      ...
      variables: [],
      conditions: ["The source notes HBr and HI are strong reducing agents and reduce $H_2SO_4$ to $SO_2$."],
      table_data: {
        columns: ["Family", "Source-backed item"],
        rows: [
          ["Chlorine", "Prepared from $KMnO_4$ or $MnO_2$ with concentrated HCl; also from NaCl by electrolysis."],
          ["Hydrogen halides", "$H_2+X_2\\rightarrow HX$ is shown as the general route."],
          ["Bleaching powder", "Composition shown as $Ca(OCl)_2\\cdot CaCl_2\\cdot Ca(OH)_2\\cdot 2H_2O$."],
        ],
      },
      importance: 4,
      source_page: 93,
    ...
    card(chapterId, "chlorine-oxides-oxyacids", {
      ...
      variables: [],
      conditions: ["Crowded map-only reactions are left to the PDF fallback."],
      table_data: {
        columns: ["Central species", "Clear source-backed links"],
        rows: [
          ["$Cl_2O$", "From $Cl_2$ and $HgO$; gives $HOCl$ with water and $KOCl$ with KOH."],
          ["$ClO_2$", "Linked to $KClO_3$, $NaClO_3$, $Cl_2O_6$, $KClO_2+KClO_3$ and $O_2+NaClO_2$."],
          ["$Cl_2O_6$", "Gives $KClO_3+KClO_4$ with KOH and $NaClO_3$ with NaOH/$H_2O_2$."],
        ],
      },
      importance: 3,
      source_page: 94,
    ...
    card(chapterId, "group-18-basics", {
      ...
      formulas: [{ latex: "\\text{Electronic configuration}=ns^2np^6" }],
      variables: [],
      conditions: ["Members listed: He, Ne, Ar, Kr, Xe and Rn."],
      table_data: {
        columns: ["Topic", "Source-backed item"],
        rows: [
          ["Air abundance", "Most abundant is Ar; order: Ar > Ne > Kr > He > Xe."],
          ["Atomic radii", "Increase down the group with atomic number."],
          ["Physical properties", "Monoatomic, colourless, tasteless and sparingly soluble in water."],
          ["Boiling/melting points", "Very low because the only interatomic interaction is weak dispersion force."],
        ],
      },
      importance: 4,
      source_page: 94,
    ...
    card(chapterId, "noble-gas-inertness-xe", {
    ...
    card(chapterId, "helium-clathrates-xef2", {
      ...
      diagram_data: { type: "chem-xef2-linear" },
      importance: 4,
      source_page: 95,
      sort_order: 26,
    }),
...
function cardsForTrack(track) {
  return [
    ...sBlockCards(chapter(track, "s-block-elements-compounds")),
    ...pBlockCards(chapter(track, "p-block-elements-compounds")),
  ];
}

export function getChemistryInorganicBatch3Chapters(track) {
  return CHEMISTRY_INORGANIC_BATCH_3_CHAPTER_DEFINITIONS.map((definition) => ({
...
export function getChemistryInorganicBatch3Cards(track) {
