  ...
  return (
    <div className="fixed bottom-5 right-5 z-40 sm:bottom-7 sm:right-7 flex flex-col items-end gap-3 pointer-events-none">
      ...
      <Link
        ...
        className="group relative flex h-12 items-center justify-center gap-2.5 rounded-full border border-brand/45 bg-white pl-4 pr-5 text-brand shadow-lg shadow-brand/10 transition-all duration-300 hover:-translate-y-0.5 hover:border-brand hover:bg-brand hover:text-slate-950 focus:outline-none focus:ring-2 focus:ring-brand/50 dark:bg-[var(--surface-elevated)] dark:shadow-black/30 sm:h-14 sm:pl-5 sm:pr-6 pointer-events-auto"
      >
        <div className="absolute inset-0 rounded-full shadow-[0_0_15px_rgba(245,158,11,0.3)] animate-pulse opacity-60 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none" />
        
        <Swords className="relative z-10 h-5 w-5 sm:h-[22px] sm:w-[22px]" aria-hidden="true" strokeWidth={2.5} />
        <span className="relative z-10 text-sm font-black uppercase tracking-[0.15em] sm:text-[15px]">Arena</span>
