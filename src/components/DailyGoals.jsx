...
export default function DailyGoals() {
  ...
  return (
    <div className="bg-[#1a1d2e] border border-[#2a2d3e] rounded-2xl p-5">
      <div className="flex items-center justify-between mb-4">
        <div>
          <h2 className="text-xs font-bold text-[#e8eaf6] uppercase tracking-widest">
            Daily Goals
          </h2>
          <p className="text-xs text-[#9396a8] mt-0.5">
            {completed} of {goals.length} completed today
          </p>
        </div>
        <div className="flex items-center gap-2">
          <div className="w-24 h-1.5 bg-[#232740] rounded-full overflow-hidden">
            <div
          ...
          <div
            ...
            className={`relative rounded-xl p-3.5 border transition-all duration-200
              ${goal.done
                ...
                : "bg-[#232740] border-[#2a2d3e] hover:border-[#363a52]"
              }`}
          >
            ...
            <p
              className={`text-xs font-semibold leading-snug mb-2
                ${goal.done
                  ? "text-emerald-400 line-through decoration-emerald-500/40"
                  : "text-[#e8eaf6]"
                }`}
            >
              {goal.label}
            ...
            {!goal.done && goal.total > 0 && (
              <div>
                ...
                <p className="text-[10px] text-[#5c5f74] mt-1">
            ...
            {!goal.done && goal.total === 0 && (
              <p className="text-[10px] text-[#5c5f74]">Not started</p>
            )}
          </div>
        ))}
      </div>
