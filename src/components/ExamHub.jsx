  ...
  return (
    <div className="relative overflow-hidden w-full rounded-3xl border border-gray-200/80 bg-gradient-to-br from-sky-400/10 via-white/80 to-sky-100/30 p-6 shadow-xl shadow-sky-500/[0.03] dark:border-[var(--border-subtle)]/60 dark:bg-gradient-to-br dark:from-[#161b22]/80 dark:via-[#0d1117]/60 dark:to-[#161b22]/40 backdrop-blur-md">
      ...
      <div className="relative z-10 flex flex-col xl:flex-row xl:items-center justify-between gap-6">
        ...
        <div className="bg-[var(--card)]/80 border border-gray-200/60 dark:bg-[#161b22]/50 dark:border-[var(--border-subtle)]/80 p-4 rounded-2xl w-full xl:w-72 shadow-sm shrink-0">
          ...
          <div className="space-y-2.5">
            {config.focusTopics.map((topic, idx) => (
              <div key={idx} className="flex items-center justify-between text-xs border-b border-gray-100 dark:border-[var(--border-subtle)]/50 pb-2 last:border-none last:pb-0">
