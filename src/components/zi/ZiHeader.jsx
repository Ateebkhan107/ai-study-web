    ...
    <header className="relative shrink-0 border-b border-[var(--border-subtle)] bg-[var(--card)]/50 px-4 pb-5 pt-6 sm:px-6">
      <div className="flex items-center justify-between gap-4">
        <div className="flex min-w-0 items-center gap-3.5">
          <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-[16px] border border-brand bg-brand shadow-sm">
            <Logo size={28} showText={false} forceLight={true} />
          </div>
        ...
        <button
          type="button"
          onClick={onClose}
          className="prepzii-interactive flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-slate-200 dark:border-white/10 bg-[var(--surface-elevated)] text-black dark:text-slate-400 transition-colors hover:border-brand/40 hover:bg-brand/10 hover:text-black dark:hover:text-white"
